<?php
$title = 'Boletas de Salida - Aprobación Final';
$styles = [
...
$scripts = [
    ...
    'js/boletas-salida/admin-panel.js'
];
ob_start();
?>
...
<div id="modalAprobar" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h3>Aprobar Solicitud - Aprobación Final</h3>
            <button class="modal-close">&times;</button>
        </div>
        <div class="modal-body">
            <p>¿Está seguro de que desea aprobar esta solicitud de salida?</p>
            <p class="text-muted">Esta será la aprobación final administrativa. La boleta estará lista para validación en portería.</p>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" id="btnCancelarAprobacion">Cancelar</button>
            <button type="button" class="btn btn-success" id="btnConfirmarAprobacion">Confirmar Aprobación</button>
        </div>
    </div>
</div>
